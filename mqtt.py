...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        if msg.topic == "sensor":
            ...
            win = float(data.get("win",0)[:-1])

            cursor = db.cursor()
            sql = "INSERT INTO sensor_data (temperature, humidity, light, win) VALUES (%s, %s, %s, %s)"
            values = (temperature, humidity, light, win)
...
client.connect("192.168.77.26", 1885, 60)
